...
public class TextDistractionController implements ScreenController  {
    ...
    private final String questionsFilePath = "assets/Interface/Text_questions/Questions.txt";
        ...
        //Constructor
    public TextDistractionController(TextDistraction textDistraction) 
	{
    ...
    public void onStartScreen() {
        ...
        { 
         writer.write("Question:      Right Answer:     [Users Answer]:");
         writer.newLine();
        } 
        catch (IOException e) {
            e.printStackTrace();
    ...
    public void sendToScreen(){
        ...
        answerField.setText("Replace this with your Answer");
