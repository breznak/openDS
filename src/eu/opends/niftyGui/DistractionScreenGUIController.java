...
import cz.cvut.cognitive.distractors.WeatherDistration;
...
public class DistractionScreenGUIController implements ScreenController 
{
	 ...
	 */
	public DistractionScreenGUIController(InstructionScreenGUI instructionScreenGUI) 
	{
	...
	public void onStartScreen() 
	{
        ...
        {  
            if (CheckBox_rain.isChecked()) {
                ...
                DistractionSettings.setProbabilityBox(10); 
